...
inline: false
related_posts: false
group: "Erasmus projects"
archive: true # university project — kept out of the front-page list
tags: ["ROS", "Multi-Agent Systems", "University Project"]
---

<img class="img-center" src="{{ site.baseurl }}/assets/img/mas.gif" alt="MAS Gif" width="1080"/>

[![GitLab](https://img.shields.io/badge/GitLab-Code-E24329)](https://gitlab.com/balthier/mas_orebro_labs)
{: .text-center}
