...
tags: ["Interpretability", "Machine Learning", "Image Classification", "University project"]
---

<img class="img-center" src="{{ site.baseurl }}/assets/img/nn_project_pic.png" alt="NN" width="500"/>

[![GitLab](https://img.shields.io/badge/GitLab-Code-E24329)](https://gitlab.com/balthier/neural_networks_project_2020)
{: .text-center}

Final project of the Neural Networks course, based on _Interpreting CNNs via Decision Trees_ \[1\].
